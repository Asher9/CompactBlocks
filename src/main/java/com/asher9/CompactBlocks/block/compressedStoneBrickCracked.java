...
public class compressedStoneBrickCracked extends Block {

	public compressedStoneBrickCracked(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
