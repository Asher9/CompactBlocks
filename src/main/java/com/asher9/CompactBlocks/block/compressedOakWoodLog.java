...
public class compressedOakWoodLog extends Block {

	public compressedOakWoodLog(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
