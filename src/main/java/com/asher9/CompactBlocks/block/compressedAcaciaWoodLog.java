...
public class compressedAcaciaWoodLog extends Block {

	public compressedAcaciaWoodLog(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
