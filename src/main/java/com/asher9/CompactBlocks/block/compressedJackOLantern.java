...
public class compressedJackOLantern extends Block {

	public compressedJackOLantern(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
