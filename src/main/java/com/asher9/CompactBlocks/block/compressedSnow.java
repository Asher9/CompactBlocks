...
public class compressedSnow extends Block {

	public compressedSnow(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
