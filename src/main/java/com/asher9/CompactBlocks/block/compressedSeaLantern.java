...
public class compressedSeaLantern extends Block {

	public compressedSeaLantern(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
