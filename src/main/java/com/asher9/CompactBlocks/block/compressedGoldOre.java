...
public class compressedGoldOre extends Block {

	public compressedGoldOre(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
