...
public class compressedHayBlock extends Block {

	public compressedHayBlock(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
