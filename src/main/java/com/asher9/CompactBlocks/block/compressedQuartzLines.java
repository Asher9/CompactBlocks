...
public class compressedQuartzLines extends Block {

	public compressedQuartzLines(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
