...
public class compressedBrick extends Block {

	public compressedBrick(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
