...
public class compressedBirchWoodLog extends Block {

	public compressedBirchWoodLog(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
