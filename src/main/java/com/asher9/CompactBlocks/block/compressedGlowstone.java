...
public class compressedGlowstone extends Block {

	public compressedGlowstone(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
