...
public class compressedMelon extends Block {

	public compressedMelon(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
