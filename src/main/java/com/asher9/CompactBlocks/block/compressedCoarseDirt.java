...
public class compressedCoarseDirt extends Block {

	public compressedCoarseDirt(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
