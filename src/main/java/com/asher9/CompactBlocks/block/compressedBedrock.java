...
public class compressedBedrock extends Block {

	public compressedBedrock(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
