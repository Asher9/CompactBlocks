...
public class compressedEmeraldOre extends Block {

	public compressedEmeraldOre(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
