...
public class compressedDiamondOre extends Block {

	public compressedDiamondOre(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
