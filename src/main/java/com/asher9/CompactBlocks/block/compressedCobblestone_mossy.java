...
public class compressedCobblestone_mossy extends Block {

	public compressedCobblestone_mossy(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
