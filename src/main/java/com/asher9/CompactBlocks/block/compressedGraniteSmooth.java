...
public class compressedGraniteSmooth extends Block {

    public compressedGraniteSmooth(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
