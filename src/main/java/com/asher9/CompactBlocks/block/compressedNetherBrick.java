...
public class compressedNetherBrick extends Block {

	public compressedNetherBrick(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
