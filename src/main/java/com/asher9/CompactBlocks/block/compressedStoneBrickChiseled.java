...
public class compressedStoneBrickChiseled extends Block {

	public compressedStoneBrickChiseled(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
