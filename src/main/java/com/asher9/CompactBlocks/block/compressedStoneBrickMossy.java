...
public class compressedStoneBrickMossy extends Block {

	public compressedStoneBrickMossy(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
