...
public class compressedRedSand extends Block {

	public compressedRedSand(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
