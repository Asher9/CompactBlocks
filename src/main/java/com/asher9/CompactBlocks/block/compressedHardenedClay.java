...
public class compressedHardenedClay extends Block implements IMetaBlockName {
	
    private static final PropertyEnum TYPE = PropertyEnum.create("type", ColorTypes.class);

    public compressedHardenedClay(Material materialIn, String unlocalizedName, float hardness, float resistance, float lightLevel, String tool, int harvestLevel, CreativeTabs creativeTab, SoundType stepSound)
    {
        super(materialIn);
