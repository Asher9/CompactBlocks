...
public class compressedEndBricks extends Block {

	public compressedEndBricks(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
