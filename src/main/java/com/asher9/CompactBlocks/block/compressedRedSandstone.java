...
public class compressedRedSandstone extends Block {

    public compressedRedSandstone(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
