...
public class compressedClay extends Block {

	public compressedClay(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
