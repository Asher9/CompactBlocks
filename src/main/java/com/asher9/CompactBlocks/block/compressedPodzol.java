...
public class compressedPodzol extends Block {

	public compressedPodzol(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
