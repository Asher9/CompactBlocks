...
public class compressedRedSandstoneCarved extends Block {

    public compressedRedSandstoneCarved(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
