...
public class oreEnderium extends Block {

	private static Item drop;
	private int least_quantity;
	private int most_quantity;

	public oreEnderium(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,String tool, int harvestLevel, CreativeTabs creativeTab, SoundType stepSound, Item drop, int least_quantity, int most_quantity) {
		super(material);
		this.drop = drop;
