...
public class compressedIronOre extends Block {

	public compressedIronOre(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
