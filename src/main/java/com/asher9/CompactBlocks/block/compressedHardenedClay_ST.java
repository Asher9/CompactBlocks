...
public class compressedHardenedClay_ST extends Block {

	public compressedHardenedClay_ST(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
