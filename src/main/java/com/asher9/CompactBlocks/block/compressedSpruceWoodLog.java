...
public class compressedSpruceWoodLog extends Block {

	public compressedSpruceWoodLog(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
