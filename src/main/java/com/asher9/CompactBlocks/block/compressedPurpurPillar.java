...
public class compressedPurpurPillar extends Block {

    public compressedPurpurPillar(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
