...
public class compressedEnderium extends Block {

	public compressedEnderium(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
