...
public class compressedEmeraldBlock extends Block {

	public compressedEmeraldBlock(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
