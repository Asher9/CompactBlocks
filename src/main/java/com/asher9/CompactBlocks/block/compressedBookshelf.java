...
public class compressedBookshelf extends Block {

	public compressedBookshelf(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
