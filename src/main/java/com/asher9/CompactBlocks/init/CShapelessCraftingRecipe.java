...
public static void ShapelessCraftingRecipe() {
	...
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.MAGMA, 9), new ItemStack(CBlocks.compressedMagmaBlock));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedMagmaBlock, 9), new ItemStack(CBlocks.doublecompressedMagmaBlock));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedMagmaBlock, 9), new ItemStack(CBlocks.triplecompressedMagmaBlock));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedMagmaBlock, 9), new ItemStack(CBlocks.quadruplecompressedMagmaBlock));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.MYCELIUM, 9), new ItemStack(CBlocks.compressedMycelium));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedMycelium, 9), new ItemStack(CBlocks.doublecompressedMycelium));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedMycelium, 9), new ItemStack(CBlocks.triplecompressedMycelium));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedMycelium, 9), new ItemStack(CBlocks.quadruplecompressedMycelium));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.PRISMARINE, 9, 1), new ItemStack(CBlocks.compressedPrismarineBricks));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedPrismarineBricks, 9), new ItemStack(CBlocks.doublecompressedPrismarineBricks));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedPrismarineBricks, 9), new ItemStack(CBlocks.triplecompressedPrismarineBricks));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedPrismarineBricks, 9), new ItemStack(CBlocks.quadruplecompressedPrismarineBricks));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.PRISMARINE, 9, 2), new ItemStack(CBlocks.compressedPrismarineDark));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedPrismarineDark, 9), new ItemStack(CBlocks.doublecompressedPrismarineDark));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedPrismarineDark, 9), new ItemStack(CBlocks.triplecompressedPrismarineDark));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedPrismarineDark, 9), new ItemStack(CBlocks.quadruplecompressedPrismarineDark));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.PRISMARINE, 9, 0), new ItemStack(CBlocks.compressedPrismarineRough));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedPrismarineRough, 9), new ItemStack(CBlocks.doublecompressedPrismarineRough));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedPrismarineRough, 9), new ItemStack(CBlocks.triplecompressedPrismarineRough));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedPrismarineRough, 9), new ItemStack(CBlocks.quadruplecompressedPrismarineRough));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.PURPUR_BLOCK, 9), new ItemStack(CBlocks.compressedPurpurBlock));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedPurpurBlock, 9), new ItemStack(CBlocks.doublecompressedPurpurBlock));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedPurpurBlock, 9), new ItemStack(CBlocks.triplecompressedPurpurBlock));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedPurpurBlock, 9), new ItemStack(CBlocks.quadruplecompressedPurpurBlock));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.PURPUR_PILLAR, 9), new ItemStack(CBlocks.compressedPurpurPillar));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedPurpurPillar, 9), new ItemStack(CBlocks.doublecompressedPurpurPillar));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedPurpurPillar, 9), new ItemStack(CBlocks.triplecompressedPurpurPillar));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedPurpurPillar, 9), new ItemStack(CBlocks.quadruplecompressedPurpurPillar));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.QUARTZ_ORE, 9), new ItemStack(CBlocks.compressedQuartzOre));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedQuartzOre, 9), new ItemStack(CBlocks.doublecompressedQuartzOre));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedQuartzOre, 9), new ItemStack(CBlocks.triplecompressedQuartzOre));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedQuartzOre, 9), new ItemStack(CBlocks.quadruplecompressedQuartzOre));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.SLIME_BLOCK, 9), new ItemStack(CBlocks.compressedSlime));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedSlime, 9), new ItemStack(CBlocks.doublecompressedSlime));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedSlime, 9), new ItemStack(CBlocks.triplecompressedSlime));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedSlime, 9), new ItemStack(CBlocks.quadruplecompressedSlime));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.RED_SANDSTONE, 9, 0), new ItemStack(CBlocks.compressedRedSandstone));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedRedSandstone, 9), new ItemStack(CBlocks.doublecompressedRedSandstone));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedRedSandstone, 9), new ItemStack(CBlocks.triplecompressedRedSandstone));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedRedSandstone, 9), new ItemStack(CBlocks.quadruplecompressedRedSandstone));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.RED_SANDSTONE, 9, 1), new ItemStack(CBlocks.compressedRedSandstoneCarved));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedRedSandstoneCarved, 9), new ItemStack(CBlocks.doublecompressedRedSandstoneCarved));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedRedSandstoneCarved, 9), new ItemStack(CBlocks.triplecompressedRedSandstoneCarved));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedRedSandstoneCarved, 9), new ItemStack(CBlocks.quadruplecompressedRedSandstoneCarved));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.RED_SANDSTONE, 9, 2), new ItemStack(CBlocks.compressedRedSandstoneSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedRedSandstoneSmooth, 9), new ItemStack(CBlocks.doublecompressedRedSandstoneSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedRedSandstoneSmooth, 9), new ItemStack(CBlocks.triplecompressedRedSandstoneSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedRedSandstoneSmooth, 9), new ItemStack(CBlocks.quadruplecompressedRedSandstoneSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.SPONGE, 9, 1), new ItemStack(CBlocks.compressedSpongeWet));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedSpongeWet, 9), new ItemStack(CBlocks.doublecompressedSpongeWet));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedSpongeWet, 9), new ItemStack(CBlocks.triplecompressedSpongeWet));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedSpongeWet, 9), new ItemStack(CBlocks.quadruplecompressedSpongeWet));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.STONE, 9, 5), new ItemStack(CBlocks.compressedAndersite));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedAndersite, 9), new ItemStack(CBlocks.doublecompressedAndersite));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedAndersite, 9), new ItemStack(CBlocks.triplecompressedAndersite));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedAndersite, 9), new ItemStack(CBlocks.quadruplecompressedAndersite));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.STONE, 9, 6), new ItemStack(CBlocks.compressedAndersiteSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedAndersiteSmooth, 9), new ItemStack(CBlocks.doublecompressedAndersiteSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedAndersiteSmooth, 9), new ItemStack(CBlocks.triplecompressedAndersiteSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedAndersiteSmooth, 9), new ItemStack(CBlocks.quadruplecompressedAndersiteSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.STONE, 9, 3), new ItemStack(CBlocks.compressedDiorite));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedDiorite, 9), new ItemStack(CBlocks.doublecompressedDiorite));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedDiorite, 9), new ItemStack(CBlocks.triplecompressedDiorite));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedDiorite, 9), new ItemStack(CBlocks.quadruplecompressedDiorite));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.STONE, 9, 4), new ItemStack(CBlocks.compressedDioriteSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedDioriteSmooth, 9), new ItemStack(CBlocks.doublecompressedDioriteSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedDioriteSmooth, 9), new ItemStack(CBlocks.triplecompressedDioriteSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedDioriteSmooth, 9), new ItemStack(CBlocks.quadruplecompressedDioriteSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.STONE, 9, 1), new ItemStack(CBlocks.compressedGranite));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedGranite, 9), new ItemStack(CBlocks.doublecompressedGranite));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedGranite, 9), new ItemStack(CBlocks.triplecompressedGranite));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedGranite, 9), new ItemStack(CBlocks.quadruplecompressedGranite));
	GameRegistry.addShapelessRecipe(new ItemStack(Blocks.STONE, 9, 2), new ItemStack(CBlocks.compressedGraniteSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.compressedGraniteSmooth, 9), new ItemStack(CBlocks.doublecompressedGraniteSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.doublecompressedGraniteSmooth, 9), new ItemStack(CBlocks.triplecompressedGraniteSmooth));
	GameRegistry.addShapelessRecipe(new ItemStack(CBlocks.triplecompressedGraniteSmooth, 9), new ItemStack(CBlocks.quadruplecompressedGraniteSmooth));
