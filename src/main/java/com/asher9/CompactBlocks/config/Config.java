...
public class Config {
    ...
    public class ConfigSection {
        ...
        private ConfigSection (List<ConfigSection> list, ConfigSection parent, String name, String lang) {
            this.parent = parent;
            this.name = name;
            this.lang = lang;
        ...
        private ConfigSection (List<ConfigSection> list, String name, String lang) {
