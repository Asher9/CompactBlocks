...
public class compressedPrismarineBricks extends Block {

    public compressedPrismarineBricks(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
