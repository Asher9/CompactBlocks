...
public class compressedPurpurBlock extends Block {

    public compressedPurpurBlock(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
