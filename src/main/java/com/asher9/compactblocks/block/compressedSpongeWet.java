...
public class compressedSpongeWet extends Block {

    public compressedSpongeWet(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
