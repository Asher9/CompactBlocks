...
public class compressedNetherWartBlock extends Block {

	public compressedNetherWartBlock(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
