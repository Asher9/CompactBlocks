...
public class compressedGranite extends Block {

    public compressedGranite(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
