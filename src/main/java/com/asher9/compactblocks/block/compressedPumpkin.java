...
public class compressedPumpkin extends Block {

	public compressedPumpkin(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
