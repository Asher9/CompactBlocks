...
public class compressedJungleWoodLog extends Block {

	public compressedJungleWoodLog(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
