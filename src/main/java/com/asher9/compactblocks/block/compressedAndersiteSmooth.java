...
public class compressedAndersiteSmooth extends Block {

    public compressedAndersiteSmooth(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
