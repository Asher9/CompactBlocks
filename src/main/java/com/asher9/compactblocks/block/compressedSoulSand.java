...
public class compressedSoulSand extends Block {

	public compressedSoulSand(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
