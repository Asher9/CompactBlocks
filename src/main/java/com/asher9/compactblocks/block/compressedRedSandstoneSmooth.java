...
public class compressedRedSandstoneSmooth extends Block {

    public compressedRedSandstoneSmooth(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
