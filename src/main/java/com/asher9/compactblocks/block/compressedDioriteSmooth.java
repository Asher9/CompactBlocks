...
public class compressedDioriteSmooth extends Block {

    public compressedDioriteSmooth(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
