...
public class compressedQuartzOre extends Block {

    public compressedQuartzOre(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
