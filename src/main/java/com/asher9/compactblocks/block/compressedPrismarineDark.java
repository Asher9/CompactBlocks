...
public class compressedPrismarineDark extends Block {

    public compressedPrismarineDark(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
