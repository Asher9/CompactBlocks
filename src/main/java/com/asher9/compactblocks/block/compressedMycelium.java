...
public class compressedMycelium extends Block {

    public compressedMycelium(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
