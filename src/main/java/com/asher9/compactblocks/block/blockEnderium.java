...
public class blockEnderium extends Block {

	public blockEnderium(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
