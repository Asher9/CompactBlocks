...
public class compressedDarkOakWoodLog extends Block {

	public compressedDarkOakWoodLog(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
