...
public class compressedPrismarineRough extends Block {

    public compressedPrismarineRough(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
