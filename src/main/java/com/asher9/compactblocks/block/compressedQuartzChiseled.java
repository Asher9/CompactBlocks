...
public class compressedQuartzChiseled extends Block {

	public compressedQuartzChiseled(Material material, String unlocalizedName, float hardness, float resistance, float lightLevel,
